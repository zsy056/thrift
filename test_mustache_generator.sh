...
# Check service files
if [ ! -f "gen-cpp/Calculator.h" ]; then
    echo "ERROR: Calculator.h was not generated by cpp generator"
    exit 1
fi

if [ ! -f "gen-mustache-cpp/Calculator.h" ]; then
    echo "ERROR: Calculator.h was not generated by mustache generator"
    exit 1
fi

if [ ! -f "gen-cpp/Calculator.cpp" ]; then
    echo "ERROR: Calculator.cpp was not generated by cpp generator"
    exit 1
fi

if [ ! -f "gen-mustache-cpp/Calculator.cpp" ]; then
    echo "ERROR: Calculator.cpp was not generated by mustache generator"
    exit 1
fi
...
# Test 6: Check basic service file generation
echo "Checking service file generation..."
if ! grep -q "class CalculatorIf" gen-mustache-cpp/Calculator.h; then
    echo "ERROR: Calculator.h does not contain service interface"
    exit 1
fi

if ! grep -q "virtual int32_t add" gen-mustache-cpp/Calculator.h; then
    echo "ERROR: Calculator.h does not contain add method"
    exit 1
fi

if ! grep -q "virtual.*reset" gen-mustache-cpp/Calculator.h; then
    echo "ERROR: Calculator.h does not contain reset method"
    exit 1
fi

if ! grep -q "class CalculatorNull" gen-mustache-cpp/Calculator.h; then
    echo "ERROR: Calculator.h does not contain Null implementation"
    exit 1
fi
